...
const CTAGrid: React.FC = () => {
  const ctas: CTAButton[] = [
    ...
    {
      title: 'Migration',
      description: 'Explore migration patterns and timing across Illinois',
      icon: <FiMap size={32} />,
      link: '/migration',
      color: 'blue',
    },
    {
      ...
      description: 'Learn about bird monitoring initiatives across Illinois',
    ...
    },
    {
      ...
      link: '/education/example-data',
      color: 'blue',
    },
    {
      title: 'Get Involved',
      description: 'Find birding opportunities and events in your area',
      icon: <FiUsers size={32} />,
      link: '/education/opportunities',
      color: 'orange',
    },
    {
      title: 'Take Action',
      ...
      link: '/conservation/what-you-can-do',
      color: 'orange',
    },
  ];
